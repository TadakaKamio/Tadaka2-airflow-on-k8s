import airflow
import ghg.scripts.insert_hive_all_script_wk as script
...
# タスクの設定
insert_hive_all = PythonOperator(
    task_id="task_insert_hive_all_wk",  # タスクのID
    python_callable=script.insert_hive_all_wk,  # 実行するPython関数
    dag=dag,  # 所属するDAG
