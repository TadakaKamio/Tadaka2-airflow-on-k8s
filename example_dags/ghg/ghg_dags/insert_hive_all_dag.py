...
import ghg.scripts.insert_hive_all_script as script
...
insert_hive_all = PythonOperator(
    task_id="task_insert_hive_all",  # タスクのID
    python_callable=script.insert_hive_all,  # 実行するPython関数
    dag=dag,  # 所属するDAG
