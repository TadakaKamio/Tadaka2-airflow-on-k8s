...
@dataclass
#建物年別
class BuildingAnnualEntity(BaseEntity):
    AREA_ID: str                              # エリアID
    AREA_INFORMATION: str                     # 事業所名
    BUILDING_ID: str                          # 建物ID
    BUILDING_NAME: str                        # 建物名

@dataclass
#建物月別
class BuildingMonthEntity(BaseEntity):
    AREA_ID: str                              # エリアID
    AREA_INFORMATION: str                     # 事業所名
    BUILDING_ID: str                          # 建物ID
    BUILDING_NAME: str                        # 建物名
...
@dataclass
# 企業毎月別集計データエンティティ
class CorporationMonthlyEntity(BaseEntity):
    YEAR:str                                  #対象年
    MONTH:str                                 #対象月
...
@dataclass
#企業毎年別集計データエンティティ
class CorporationYearlyEntity(BaseEntity):
    CO2_EMISSIONS_RANKING: str                # CO2排出量ランキング
